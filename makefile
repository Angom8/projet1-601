...
EXEC = main
OBJETS = ncursesController.o windowActions.o DataManager.o 
NOM_PROJET = ncurses_projet1_THEBAULT_ANTOINE_INFO0601_
...
CC = gcc
CCFLAGS_STD = -Wall -O3 -Werror -ansi -pedantic -fexec-charset=ISO-8859-1 -finput-charset=ISO-8859-1
...
# DEPENDANCES
ncursesController.o: ncursesController.c ncursesController.h
windowActions.o: windowActions.c windowActions.h
DataManager.o : DataManager.c DataManager.h
